...
_Images of Central Baptist Church from the [Rhode Island State Archives](https://www.sos.ri.gov/divisions/state-archives) *![external link](../images/external-link.gif)*_
...
_The Modern Theater in 1916, showing the street corner just outside of Chinatown following its destruction in 1914, from [CinemaTreasures.org](http://cinematreasures.org/theaters/6596/photos/336594) *![external link](../images/external-link.gif*, dated from the posters of what was playing at the time._


### Theaters

I used the website [CinemaTreasures.org](http://cinematreasures.org) *![external link](../images/external-link.gif)*, which includes a detailed user-contributed history of stage theaters, from construction dates, to name changes, to photographs, and even dating images based on the posters of shows currently playing. I looked at the Photos and Comments tabs of a page to see user contributions.
